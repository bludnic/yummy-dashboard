          ...
          <v-layout row wrap>
            ...
            <v-flex xs12>
              <v-card>
                ...
                <v-list two-line subheader>
                  ...
                  <v-list-tile avatar>
                    ...
                    <v-list-tile-content>
                      ...
                      <v-list-tile-sub-title>{{ parseDate(product.updatedAt) }}</v-list-tile-sub-title>
                    </v-list-tile-content>
                    <v-list-tile-action>
                      <v-btn icon ripple>
                        <v-icon color="grey lighten-1">info</v-icon>
                ...
                <v-card-actions>
                  <v-btn block color="primary" @click="saveMenuItem">Save</v-btn>
                </v-card-actions>
              </v-card>
            </v-flex>
...
export default {
  async asyncData ({ app, params }) {
    const id = params.id
    const product = await app.$axios.$get(`/menu/${id}`)
  ...
  methods: {
    saveMenuItem () {
      ...
      this.$axios.$put(`/menu/${id}`, this.product)
      .then(res => {
